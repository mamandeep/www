...
<div>Please note that above information is for information only and to assist you in making an informed decision. Seats will be offered based on the merit list to be prepared out of the choices locked by the candidates in each round. Candidates of M-Tech/M-Pharm may please note that above position is likely to change after verification of GATE/GPAT scores.</div>
<label>> <span style="color: green;">On 19th June, 2018 between 6 A.M. to 3 P.M. each candidate will be required to lock any one seat out of the preferences already filled by her/him. </span> One candidate can <span style="text-decoration: underline;">Lock only One Programme</span> in each round and his/her name will not be considered in other programmes in merit lists of that round. In the next round, she/he can again lock same/different preference and so on.</label>
