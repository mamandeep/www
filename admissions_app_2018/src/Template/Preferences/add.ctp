...
<p>Note: For Test Paper Code PGQP03, PGQP06, PGQP38 please enter zero(0) under Column 'Marks A' and Total Marks in both Column 'Marks B' and Column 'Total Marks'.</p>
...
?>
<br/><br/><br/>
<div>Note: To reset the filled preferences and re-submit the form <?php echo $this->Html->link(
    'click here',
