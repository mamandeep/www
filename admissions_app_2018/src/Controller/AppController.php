...
class AppController extends Controller
{
	...
	if (isset($user['role']) && $user['role'] === 'exam') {
            return true;
        }
    ...
    protected function isFormFillingOpen() {
        ...
        $open_datetime = new DateTime("2018-07-18 08:59:59", new DateTimeZone('Asia/Calcutta'));
        $close_datetime = new DateTime("2018-07-18 14:59:59", new DateTimeZone('Asia/Calcutta'));
    ...
    protected function isViewSeatOpen() {
        $current_datetime = new DateTime();
        $current_datetime->setTimezone(new DateTimeZone('Asia/Calcutta'));
        $open_datetime = new DateTime("2018-06-18 12:00:00", new DateTimeZone('Asia/Calcutta'));
        $close_datetime = new DateTime("2018-06-30 14:59:59", new DateTimeZone('Asia/Calcutta'));
        if ($current_datetime >= $open_datetime && $current_datetime <= $close_datetime) {
            return true;
        }
        else {
    ...
    protected function isLockingSeatOpen() {
        $current_datetime = new DateTime();
        $current_datetime->setTimezone(new DateTimeZone('Asia/Calcutta'));
        $open_datetime = new DateTime("2018-07-20 05:59:59", new DateTimeZone('Asia/Calcutta'));
        $close_datetime = new DateTime("2018-07-21 14:59:59", new DateTimeZone('Asia/Calcutta'));
        if ($current_datetime >= $open_datetime && $current_datetime <= $close_datetime) {
            return true;
        }
        else {
    ...
    protected function isSubmitFeeOpen() {
        $current_datetime = new DateTime();
        $current_datetime->setTimezone(new DateTimeZone('Asia/Calcutta'));
        $open_datetime = new DateTime("2018-08-11 05:59:59", new DateTimeZone('Asia/Calcutta'));
        $close_datetime = new DateTime("2018-08-11 14:59:59", new DateTimeZone('Asia/Calcutta'));
        if ($current_datetime >= $open_datetime && $current_datetime <= $close_datetime) {
            return true;
        }
        else {
