...
<div id="contentContainer" style="width: 650px; margin-left: 100px;">
    ...
    <table id="onlineformdata"  class="print_table" style="table-layout:fixed;">
        ...
        <tr>
            ...
            <td style="word-wrap: normal;" class="print_value">DD No.:<?php echo $applicant['Applicant']['appfee_dd_no']?> Date:<?php echo $applicant['Applicant']['appfee_dd_date']?> Amount:<?php echo $applicant['Applicant']['appfee_dd_amt']?> Bank:<?php echo $applicant['Applicant']['appfee_dd_bank']?> Branch:<?php echo $applicant['Applicant']['appfee_dd_branch']?>
            </td>
        </tr>
        <br />
        <tr>
    ...
    <table>
        ...
        <tr>
            ...
            <td style="width: 40%;">
                ...
                <?php echo $this->Form->create('Temp', array('id' => 'Temp_Details', 'url' => Router::url( null, true ))); ?>
                <?php echo $this->Form->input('Image.id', array('type' => 'hidden','name' => 'temp', 'value' => 'temp')); ?>
