...
<ul class="sidebar-menu">
    ...
    <?php if(!isset($user) || empty($user['id'])) { ?>
        ...
        <li class="treeview active">
            ...
            <ul class="treeview-menu">
                ...
                -->
		<li><a href="<?php echo $this->request->webroot . 'files/Disclaimer and Privacy Policy.pdf'; ?>"><i class="fa fa-circle-o"></i> Disclaimer and Privacy Policy</a></li>		
    ...
    <?php if(isset($user) && !empty($user['id']) && $user['role'] === 'student') { ?>
        <li class="treeview active">
            ...
            <ul class="treeview-menu">
                <li><a href="<?php echo $this->Url->build('/students/msf_index/' . $user['id']); ?>"><i class="fa fa-circle-o"></i> Application Form</a></li>
                <li><a href="<?php echo $this->Url->build('/uploadfiles/upload/' . $user['id']); ?>"><i class="fa fa-circle-o"></i> Upload</a></li>
                <li><a href="<?php echo $this->Url->build('/students/allotment/' . $user['id']); ?>"><i class="fa fa-circle-o"></i> Allotment Details</a></li>
                <li><a href="<?php echo $this->Url->build('/students/printform/' . $user['id']); ?>"><i class="fa fa-circle-o"></i> Print Form</a></li>
            </ul>
        </li>
        <li class="treeview active">
            <a href="#">
    ...
    <?php } ?>
    <?php if(isset($user) && !empty($user['id']) && $user['role'] === 'examination') { ?>
        <li class="treeview">
            <a href="#">
        ...
        <li><a href="<?php echo $this->Url->build('/admin/addstudentinfo/' . $user['id']); ?>"><i class="fa fa-circle-o"></i> Add Student</a></li>
                ...
                <li><a href="<?php echo $this->Url->build('/batches/index/' . $user['id']); ?>"><i class="fa fa-circle-o"></i> Batches</a></li>
                <li><a href="<?php echo $this->Url->build('/semesters/index/' . $user['id']); ?>"><i class="fa fa-circle-o"></i> Semesters</a></li>
                <li><a href="<?php echo $this->Url->build('/sessions/index/' . $user['id']); ?>"><i class="fa fa-circle-o"></i> Sessions</a></li> */ ?>
            </ul>
        </li>
        <li class="treeview active">
            <a href="#">
