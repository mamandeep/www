...
<nav class="navbar navbar-static-top" role="navigation">
    ...
    <?php echo $this->Html->link('Confirm Mobile', array('controller' => 'registrations',
                                                                         'action' => 'confirmmobile'), array('class' => 'btn btn-default btn-flat', 'style' => 'float: none;')); ?>
    <?php } ?>
    <?php if(isset($user) && !empty($user['id'])) { //echo $this->Html->image('user2-160x160.jpg', array('class' => 'user-image', 'alt' => 'User Image')); ?>
                <strong style="color: white;">&lt;&lt;Welcome <?php echo $user['email']; ?>&gt;&gt;</strong>
