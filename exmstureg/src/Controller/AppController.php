...
{	
    ...
    public function isAuthorized($user)
    {
        ...
        if (isset($user['role']) && $user['role'] === 'examination') {
            return true;
        }
    ...
    protected function isFormFillingOpen() {
        ...
        $open_datetime = new DateTime("2018-04-01 08:59:59", new DateTimeZone('Asia/Calcutta'));
        $close_datetime = new DateTime("2018-07-30 23:59:59", new DateTimeZone('Asia/Calcutta'));
    ...
    protected function isSubmitFeeOpen() {
        $current_datetime = new DateTime();
        $current_datetime->setTimezone(new DateTimeZone('Asia/Calcutta'));
        $open_datetime = new DateTime("2017-12-27 09:29:59", new DateTimeZone('Asia/Calcutta'));
        //$close_datetime = new DateTime("2017-07-16 23:59:59", new DateTimeZone('Asia/Calcutta'));
        $close_datetime = new DateTime("2018-01-25 23:59:59", new DateTimeZone('Asia/Calcutta'));
        if ($current_datetime >= $open_datetime && $current_datetime <= $close_datetime) {
            return true;
        }
        else {
    ...
    protected function isFineApplicable() {
        $current_datetime = new DateTime();
        $current_datetime->setTimezone(new DateTimeZone('Asia/Calcutta'));
        $open_datetime = new DateTime("2018-01-04 00:00:00", new DateTimeZone('Asia/Calcutta'));
