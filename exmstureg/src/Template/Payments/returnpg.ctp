...
<table>
    ...
    <tr>
        ...
        <td><?php echo $studentdata['Registration_No']; ?></td>
    </tr>
    <?php if(isset($feeType) && $feeType === "academic") {?>
    <tr>
        <td colspan="2">Academic Fees</td>
    </tr>
    <?php } ?>
    <?php if(isset($feeType) && $feeType === "hostel") {?>
    <tr>
        <td colspan="2">Hostel Fees</td>
    </tr>
    <?php }?>
    <?php if(isset($late_fee_applied) && $late_fee_applied === true) {?>
    <tr>
        <td colspan="2">Late fee fine applied</td>
    </tr>
    <?php }?>
    <tr>
        <td>Status:</td>
...
<table>
    <tr>
        <td>Your payment failed. Please contact Support along with screenshot of details of payment.</td>
    </tr>
    <tr>
