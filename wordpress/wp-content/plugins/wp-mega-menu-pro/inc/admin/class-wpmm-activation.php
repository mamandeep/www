...
if ( !class_exists( 'WPMM_Activation' ) ) {
    class WPMM_Activation extends WPMM_Libary{
        /**
        ...
        function __construct() {
             ...
             register_activation_hook(APMM_PRO_PATH . 'wp-mega-menu-pro.php', array($this,'apmm_pro_activation' ));
        }
     ...
     */
     function apmm_pro_activation(){
       ...
       if ( is_multisite() ) {
        include(APMM_PRO_PATH.'inc/backend/multisite-activation.php');
      }else{
       include(APMM_PRO_PATH.'inc/backend/activation.php');
      }   
