...
<div class="apmm-settings-main-wrapper">
    ...
    if(isset($_GET['success_message'])){ 
        if($_GET['success_message'] == 1){?>
         <div class="notice notice-success apmm-message">
            <p><?php _e('Custom Theme Updated Successfully.',APMM_PRO_TD);?></p>
         </div>
    <?php }else if($_GET['success_message'] == 2){?>
         <div class="notice notice-success apmm-message">
            <p><?php _e('Custom Theme Added Successfully.',APMM_PRO_TD);?></p>
         </div>
    <?php }
    } if(isset($_GET['message'])){  
        if($_GET['message'] == 3){?>
         <div class="notice notice-success apmm-message">
            <p><?php _e('Custom theme Copied Successfully.',APMM_PRO_TD);?></p>
         </div>
    <?php }else if($_GET['message'] == 4){?>
         <div class="notice notice-success apmm-message">
            <p><?php _e('Custom Theme deleted successfully.',APMM_PRO_TD);?></p>
         </div>
    <?php }
    } ?>
