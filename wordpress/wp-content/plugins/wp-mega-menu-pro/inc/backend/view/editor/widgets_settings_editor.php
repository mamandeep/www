					...
					<table cellspacing="0" class="widefat apmm_create_seciton">
						...
						<tr>
							  <td>
								...
								<p class="description">Set common background color for button available by our plugin's all widget.</p>
							</td>
							<td>
							
							<label class="ap-mega_container-padding">
							  <input type="text" value="<?php echo (!isset($widgets_button_bgcolor))?'':esc_attr($widgets_button_bgcolor);?>" name="apmm_theme[widgets][button_bgcolor]" 
							class="apmega-menu_bar_padding apmm-color-picker">
							</label>
							</td>
						 </tr>
						 ...
						 <tr>
							  <td>
								...
								<p class="description">Set common background hover color for button available by our plugin's all widget.</p>
							</td>
							<td>
							
							<label class="ap-mega_container-padding">
							  <input type="text" value="<?php echo (!isset($widgets_button_bghcolor))?'':esc_attr($widgets_button_bghcolor);?>" name="apmm_theme[widgets][button_bghcolor]" 
							class="apmega-menu_bar_padding apmm-color-picker">
							</label>
							</td>
						 </tr>
						 ...
						 <tr>
							  <td>
								...
								<p class="description">Set common font color for button available by our plugin's all widget.</p>
							</td>
							<td>
							
							<label class="ap-mega_container-padding">
							  <input type="text" value="<?php echo (!isset($widgets_button_fcolor))?'':esc_attr($widgets_button_fcolor);?>" name="apmm_theme[widgets][button_fcolor]" 
							class="apmega-menu_bar_padding apmm-color-picker">
							</label>
							</td>
						 </tr>
						 ...
						 <tr>
							  <td>
								...
								<p class="description">Set common font hover color for button available by our plugin's all widget.</p>
							</td>
							<td>
							
							<label class="ap-mega_container-padding">
							  <input type="text" value="<?php echo (!isset($widgets_button_fhcolor))?'':esc_attr($widgets_button_fhcolor);?>" name="apmm_theme[widgets][button_fhcolor]" 
							class="apmega-menu_bar_padding apmm-color-picker">
							</label>
							</td>
						 </tr>
