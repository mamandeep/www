...
if(isset($_GET['theme_id'])){
      ...
      if(isset($theme_settings['widgets'])){
			...
			$widgets_button_bgcolor         = (isset($theme_settings['widgets']['button_bgcolor'])?$theme_settings['widgets']['button_bgcolor']:'');
			$widgets_button_bghcolor         = (isset($theme_settings['widgets']['button_bghcolor'])?$theme_settings['widgets']['button_bghcolor']:'');
			$widgets_button_fcolor         = (isset($theme_settings['widgets']['button_fcolor'])?$theme_settings['widgets']['button_fcolor']:'');
			$widgets_button_fhcolor         = (isset($theme_settings['widgets']['button_fhcolor'])?$theme_settings['widgets']['button_fhcolor']:'');
