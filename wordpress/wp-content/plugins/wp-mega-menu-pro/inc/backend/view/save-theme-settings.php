...
wp_redirect(admin_url('admin.php?page=wpmm-add-theme-pro&action=edit_theme&theme_id='.$themeid.'&_wpnonce='.$nonce.'&success_message=1'));
...
wp_redirect(admin_url('admin.php?page=wpmm-theme-pro-settings&success_message=2'));
}
exit();
