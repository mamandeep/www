...
$enable_custom_styling = (isset($wpmmenu_item_meta['custom_styling']['enable_custom_styling']) && $wpmmenu_item_meta['custom_styling']['enable_custom_styling'] == 'true')?'true':'false';
$enable_menu_bg_color = (isset($wpmmenu_item_meta['custom_styling']['enable_menu_bg_color']) && $wpmmenu_item_meta['custom_styling']['enable_menu_bg_color'] == 'true')?'true':'false';
?>
<div class="wpmm_mega_settings">
  <div class="settings_content">
      ...
      <p class="description"><?php _e("Note: Set below custom styling for each menu items.This values setup will override the styling setup of available theme as well as custom theme.", APMM_PRO_TD); ?></p>
	   ...
	   <?php
	   	$enable_menu_bg_hover_color = (isset($wpmmenu_item_meta['custom_styling']['enable_menu_bg_hover_color']) && $wpmmenu_item_meta['custom_styling']['enable_menu_bg_hover_color'] == 'true')?'true':'false';
		?>	
			<tr>
			...
			<td class="wpmm_meta_table"><label for="enable_menu_font_color"><?php _e("Menu Font Color", APMM_PRO_TD) ?></label></td>
			  <td> 
			  <?php
			   	$enable_menu_font_color = (isset($wpmmenu_item_meta['custom_styling']['enable_menu_font_color']) && $wpmmenu_item_meta['custom_styling']['enable_menu_font_color'] == 'true')?'true':'false';
				?>	
			       <div class="wpmm-section">
			       <div class="left-section-styling">
				       <div class="wpmm-switch">
		 ...
		 <tr>
			<td class="wpmm_meta_table"><label for="enable_menu_font_hover_color"><?php _e("Menu Font Hover Color", APMM_PRO_TD) ?></label></td>
			  <td> 
			   <?php
			   	$enable_menu_font_hover_color = (isset($wpmmenu_item_meta['custom_styling']['enable_menu_font_hover_color']) && $wpmmenu_item_meta['custom_styling']['enable_menu_font_hover_color'] == 'true')?'true':'false';
				?>	
			       <div class="wpmm-section">
			       <div class="left-section-styling">
				       <div class="wpmm-switch">
			...
			<td class="wpmm_meta_table"><label for="enable_submenu_megamenu_width"><?php _e("Sub Menu/Mega Menu Width", APMM_PRO_TD) ?></label></td>
			  <td> 
			  <?php
			   	$enable_submenu_megamenu_width = (isset($wpmmenu_item_meta['custom_styling']['enable_submenu_megamenu_width']) && $wpmmenu_item_meta['custom_styling']['enable_submenu_megamenu_width'] == 'true')?'true':'false';
				?>	
			       <div class="wpmm-section">
			       <div class="left-section-styling">
				       <div class="wpmm-switch">
		...
		<tr>
			<td class="wpmm_meta_table"><label for="enable_submenu_bg_color"><?php _e("Sub Menu Background Color", APMM_PRO_TD) ?></label></td>
			  <td> 
			  <?php
			   	$enable_submenu_bg_color = (isset($wpmmenu_item_meta['custom_styling']['enable_submenu_bg_color']) && $wpmmenu_item_meta['custom_styling']['enable_submenu_bg_color'] == 'true')?'true':'false';
				?>	
			       <div class="wpmm-section">
			       <div class="left-section-styling">
				       <div class="wpmm-switch">
        ...
        <tr>
			<td class="wpmm_meta_table"><label for="enable_sub_heading_font_color"><?php _e("Sub Menu Header Font Color", APMM_PRO_TD) ?></label></td>
			  <td> 
			  <?php
			   	$enable_sub_heading_font_color = (isset($wpmmenu_item_meta['custom_styling']['enable_sub_heading_font_color']) && $wpmmenu_item_meta['custom_styling']['enable_sub_heading_font_color'] == 'true')?'true':'false';
				?>
			       <div class="wpmm-section">
			       <div class="left-section-styling">
				       <div class="wpmm-switch">
			...
			<td class="wpmm_meta_table"><label for="enable_sub_cfont_color"><?php _e("Sub Menu Content Color", APMM_PRO_TD) ?></label></td>
			  <td> 
			   <?php
			   	$enable_sub_cfont_color = (isset($wpmmenu_item_meta['custom_styling']['enable_sub_cfont_color']) && $wpmmenu_item_meta['custom_styling']['enable_sub_cfont_color'] == 'true')?'true':'false';
				?>
			       <div class="wpmm-section">
			       <div class="left-section-styling">
				       <div class="wpmm-switch">
			...
			<td class="wpmm_meta_table"><label for="enable_menu_icon_color"><?php _e("Menu Icon Color", APMM_PRO_TD) ?></label></td>
			  <td> 
			  <?php
			   	$enable_menu_icon_color = (isset($wpmmenu_item_meta['custom_styling']['enable_menu_icon_color']) && $wpmmenu_item_meta['custom_styling']['enable_menu_icon_color'] == 'true')?'true':'false';
				?>
			       <div class="wpmm-section">
			       <div class="left-section-styling">
				       <div class="wpmm-switch">
			...
			<td class="wpmm_meta_table"><label for="enable_menu_icon_hover_color"><?php _e("Menu Icon Hover Color", APMM_PRO_TD) ?></label></td>
			  <td> 
			   <?php
			   	$enable_menu_icon_hover_color = (isset($wpmmenu_item_meta['custom_styling']['enable_menu_icon_hover_color']) && $wpmmenu_item_meta['custom_styling']['enable_menu_icon_hover_color'] == 'true')?'true':'false';
				?>
			       <div class="wpmm-section">
			       <div class="left-section-styling">
				       <div class="wpmm-switch">
...
$display_mode = (isset($wpmmenu_item_meta['restriction_roles']['display_mode']) && $wpmmenu_item_meta['restriction_roles']['display_mode'] != '')?esc_attr($wpmmenu_item_meta['restriction_roles']['display_mode']):'show_to_all';
  ?>
<table class="widefat">
			<tr>
				...
				<td>
				    <select name='wpmm_settings[restriction_roles][display_mode]' class="wpmm_display_mode">
				        <option value='show_to_all' <?php echo selected( $display_mode, 'show_to_all', false );?>><?php _e("Show To All", APMM_PRO_TD); ?></option>
				        <option value='logged_in_users' <?php echo selected( $display_mode, 'logged_in_users', false );?>><?php _e("Hide to Logged In Users", APMM_PRO_TD); ?></option>
				        <option value='logged_out_users' <?php echo selected( $display_mode, 'logged_out_users', false );?>><?php _e("Hide to All Logged Out Users", APMM_PRO_TD); ?></option>
				        <option value='all_users' <?php echo selected( $display_mode, 'all_users', false );?>><?php _e("All Users Except Administrator", APMM_PRO_TD); ?></option>
				        <option value='by_role' <?php echo selected( $display_mode, 'by_role', false );?>><?php _e("By Role", APMM_PRO_TD); ?></option>
				    <select>
