...
$use_custom_settings = (isset($wpmmenu_item_meta['upload_image_settings']['use_custom_settings']) && $wpmmenu_item_meta['upload_image_settings']['use_custom_settings'] == 'true')?'true':'false';
$show_description = (isset($wpmmenu_item_meta['upload_image_settings']['show_description']) && $wpmmenu_item_meta['upload_image_settings']['show_description'] == 'true')?'true':'false';
$display_readmore = (isset($wpmmenu_item_meta['upload_image_settings']['display_readmore']) && $wpmmenu_item_meta['upload_image_settings']['display_readmore'] == 'true')?'true':'false';
$display_post_date = (isset($wpmmenu_item_meta['upload_image_settings']['display_post_date']) && $wpmmenu_item_meta['upload_image_settings']['display_post_date'] == 'true')?'true':'false';
$display_author_name = (isset($wpmmenu_item_meta['upload_image_settings']['display_author_name']) && $wpmmenu_item_meta['upload_image_settings']['display_author_name'] == 'true')?'true':'false';
$display_cat_name = (isset($wpmmenu_item_meta['upload_image_settings']['display_cat_name']) && $wpmmenu_item_meta['upload_image_settings']['display_cat_name'] == 'true')?'true':'false';

$posts_images_type = (isset($wpmmenu_item_meta['upload_image_settings']['display_posts_images']) && $wpmmenu_item_meta['upload_image_settings']['display_posts_images'] == 'featured-image')?'featured-image':'custom-image';
$text_position = (isset($wpmmenu_item_meta['upload_image_settings']['text_position']) && $wpmmenu_item_meta['upload_image_settings']['text_position'] != '')?esc_attr($wpmmenu_item_meta['upload_image_settings']['text_position']):'left';
?>
           ...
           <tr>
			...
			<td>
			     ...
			     <input type='checkbox' class='use_custom_settings' id="use_custom_settings"
			      name='wpmm_settings[upload_image_settings][use_custom_settings]' value='true' <?php echo checked($use_custom_settings,'true', false ); ?>/>
          ...
          <tr>
			...
			<td>
			     <select name='wpmm_settings[upload_image_settings][display_posts_images]' class="wpmm-displaypostimg">
			        <option value='featured-image' <?php echo selected( $posts_images_type, 'featured-image', false );?>><?php _e("Featured Image", APMM_PRO_TD); ?></option>
			        <option value='custom-image' <?php echo selected( $posts_images_type, 'custom-image', false );?>><?php _e("Custom Image", APMM_PRO_TD); ?></option>
			    <select>
		  ...
		  <tr>
			...
			<td>
			    <div class="wpmm-switch">
			     <input type='checkbox' class='wpmm_menu_settingss' id="show_excerpt"
			      name='wpmm_settings[upload_image_settings][show_description]' value='true' <?php echo checked($show_description,'true', false ); ?>/>
			...
			<td class="wpmm_meta_table">
			 ...
			 <td>
			     <input type='number' class='wpmm_menu_settingss' id="show_desc_length"
			      ...
			      value='<?php echo (isset($wpmmenu_item_meta['upload_image_settings']['show_desc_length'])?intval($wpmmenu_item_meta['upload_image_settings']['show_desc_length']):'10');?>'/>
			 </td>
			</tr>
			<tr>
				<td class="wpmm_meta_table">
				...
				<div class="wpmm-switch">
			      ...
			      name='wpmm_settings[upload_image_settings][display_readmore]' value='true' <?php echo checked($display_readmore,'true', false ); ?>/>
			...
			<tr>
				...
				<div class="wpmm-switch">
			      ...
			      name='wpmm_settings[upload_image_settings][display_post_date]' value='true' <?php echo checked($display_post_date,'true', false ); ?>/>
			...
			<tr>
				...
				<div class="wpmm-switch">
			      ...
			      name='wpmm_settings[upload_image_settings][display_author_name]' value='true' <?php echo checked($display_author_name,'true', false ); ?>/>
			...
			<tr>
				...
				<div class="wpmm-switch">
			         ...
			         name='wpmm_settings[upload_image_settings][display_cat_name]' value='true' <?php echo checked($display_cat_name,'true', false ); ?>/>
		  ...
		  <tr>
			...
			<td>
			     <select name='wpmm_settings[upload_image_settings][text_position]' class="wpmm_textposition">
			        <option value='left' <?php echo selected( $text_position, 'left', false );?>><?php _e("Image Left", APMM_PRO_TD); ?></option>
			        <option value='right' <?php echo selected( $text_position, 'right', false );?>><?php _e("Image Right", APMM_PRO_TD); ?></option>
			        <option value='top' <?php echo selected( $text_position, 'top', false );?>><?php _e("Image Top", APMM_PRO_TD); ?></option>
			        <option value='onlyimage' <?php echo selected( $text_position, 'onlyimage', false );?>><?php _e("Only Image", APMM_PRO_TD); ?></option>
			    <select>
			</td>
			</tr>
