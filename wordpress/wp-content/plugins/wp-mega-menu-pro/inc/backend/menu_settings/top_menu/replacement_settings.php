...
$choose_menu_type = (isset($wpmmenu_item_meta['mega_menu_settings']['choose_menu_type']) && $wpmmenu_item_meta['mega_menu_settings']['choose_menu_type'] != '')?esc_attr($wpmmenu_item_meta['mega_menu_settings']['choose_menu_type']):'default';
 ?>
<div class="settings_title"><h4><?php _e('Menu Replacement Settings',APMM_PRO_TD);?></h4></div>
<div class="wpmm_mega_settings"><table class="widefat">
<tr>
...
<select name="wpmm_settings[mega_menu_settings][choose_menu_type]" id="wpmm_choose_menu_type">
	<option value="default" <?php echo selected( $choose_menu_type, 'default', false );?>>Default</option>
	<option value="search_type" <?php echo selected( $choose_menu_type, 'search_type', false );?>><?php _e('Search Type',APMM_PRO_TD);?></option>
	<option value="logo_image" <?php echo selected( $choose_menu_type, 'logo_image', false );?>><?php _e('Logo Image',APMM_PRO_TD);?></option>
	<!-- <option value="html" <?php echo selected( $choose_menu_type, 'shortcode', false );?>><?php _e('HTML/Shortcode',APMM_PRO_TD);?></option> -->
	<?php if(WPMM_Libary::is_woocommerce_activated()){ ?>
   <option value="woo_cart_total" <?php echo selected( $choose_menu_type, 'woo_cart_total', false );?>><?php _e('Woocommerce Cart Total',APMM_PRO_TD);?></option>
   <!-- <option value="woo_wishlist" <?php echo selected( $choose_menu_type, 'woo_wishlist', false );?>><?php _e('Woocommerce Wislist',APMM_PRO_TD);?></option> -->
	<?php }?>
	<option value="login_form" <?php echo selected( $choose_menu_type, 'login_form', false );?>><?php _e('Login Form',APMM_PRO_TD);?></option>
	<option value="register_form" <?php echo selected( $choose_menu_type, 'register_form', false );?>><?php _e('Register Form',APMM_PRO_TD);?></option>
</select>
...
<?php	/* 	<tr class="toggle_woo_cart_total">
   ...
   <tr class="toggle_woo_cart_total">
	...
	<td class="wpmm_meta_table"><label><?php _e("Login Form Shortcode", APMM_PRO_TD) ?></label></td>
	  ...
	  <p class="description">
	     <?php _e('Use Our Default Login form Shortcode or any other external login custom shortcode for user login form on popup modal',APMM_PRO_TD);?></p>
		<p class="description">
	...
	<td class="wpmm_meta_table"><label><?php _e("Register Form Shortcode", APMM_PRO_TD) ?></label></td>
	  ...
	  <p class="description">
	     <?php _e('Use Our Default Register form Shortcode or any other external register custom shortcode for user register form on popup modal',APMM_PRO_TD);?></p>
		<p class="description">
