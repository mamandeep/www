...
$disable_text = (isset($wpmmenu_item_meta['general_settings']['disable_text']) && $wpmmenu_item_meta['general_settings']['disable_text'] == 'true')?'true':'false';
$disable_desc = (isset($wpmmenu_item_meta['general_settings']['disable_desc']) && $wpmmenu_item_meta['general_settings']['disable_desc'] == 'true')?'true':'false';
$visible_hidden_menu = (isset($wpmmenu_item_meta['general_settings']['visible_hidden_menu']) && $wpmmenu_item_meta['general_settings']['visible_hidden_menu'] == 'true')?'true':'false';
$active_link = (isset($wpmmenu_item_meta['general_settings']['active_link']) && $wpmmenu_item_meta['general_settings']['active_link'] == 'true')?'true':'false';
$hide_arrow = (isset($wpmmenu_item_meta['general_settings']['hide_arrow']) && $wpmmenu_item_meta['general_settings']['hide_arrow'] == 'true')?'true':'false';
$hide_on_mobile = (isset($wpmmenu_item_meta['general_settings']['hide_on_mobile']) && $wpmmenu_item_meta['general_settings']['hide_on_mobile'] == 'true')?'true':'false';
$hide_on_desktop = (isset($wpmmenu_item_meta['general_settings']['hide_on_desktop']) && $wpmmenu_item_meta['general_settings']['hide_on_desktop'] == 'true')?'true':'false';
$menu_icon = (isset($wpmmenu_item_meta['general_settings']['menu_icon']) && $wpmmenu_item_meta['general_settings']['menu_icon'] == 'enabled')?'enabled':'';
$active_single_menu = (isset($wpmmenu_item_meta['general_settings']['active_single_menu']) && $wpmmenu_item_meta['general_settings']['active_single_menu'] == 'enabled')?'enabled':'';
$activate_view_more_btn = (isset($wpmmenu_item_meta['general_settings']['activate_view_more_btn']) && $wpmmenu_item_meta['general_settings']['activate_view_more_btn'] == 'true')?'true':'false';
      ...
      <div class="settings_title"><h4><?php _e('Menu Item Settings',APMM_PRO_TD);?></h4></div>
  	   <table class="widefat">
			...
			<td class="wpmm_meta_table"><label for="disable_menu_text"><?php _e("Hide Menu Text", APMM_PRO_TD) ?></label></td>
			  <td> 
			       <div class="wpmm-switch">
			          <input type='checkbox' class='wpmm_menu_settingss' id="disable_menu_text" name='wpmm_settings[general_settings][disable_text]' value='true' <?php echo checked($disable_text,'true', false ); ?>/>
			          <label for="disable_menu_text"></label>
                    </div>
                     <p class="description"><?php _e("Note: Enable this option if you want to hide menu title and its height will also set to 0.", APMM_PRO_TD); ?></p>
			  </td>
			</tr>	
			<tr>
			<td class="wpmm_meta_table"><label for="disable_desc"><?php _e("Disable Description", APMM_PRO_TD) ?></label></td>
			  <td> 
			       <div class="wpmm-switch">
			          <input type='checkbox' class='wpmm_menu_settingss' id="disable_desc" name='wpmm_settings[general_settings][disable_desc]' value='true' <?php echo checked($disable_desc,'true', false ); ?>/>
			...
			<td class="wpmm_meta_table"><label for="visible_hidden_text"><?php _e("Hide Menu Text With Visible Height", APMM_PRO_TD) ?></label></td>
			  <td> 
			       <div class="wpmm-switch">
			          <input type='checkbox' class='wpmm_menu_settingss' id="visible_hidden_text" name='wpmm_settings[general_settings][visible_hidden_menu]' value='true' <?php echo checked($visible_hidden_menu,'true', false ); ?>/>
			          <label for="visible_hidden_text"></label>
                    </div>
                    
                      <p class="description"><?php _e("Note: Enable this option if you want to hide menu title but the respective height of this menu text will be displayed.", APMM_PRO_TD); ?></p>
			...
			<td class="wpmm_meta_table"><label for="active_menu_link"><?php _e("Active Menu Link", APMM_PRO_TD) ?></label></td>
				  <td> 
					  <div class="wpmm-switch">
					      ...
					      name='wpmm_settings[general_settings][active_link]' value='true' <?php echo checked($active_link,'true', false ); ?>/>
			...
			<td class="wpmm_meta_table"><label for="hide_arrow"><?php _e("Hide Arrow", APMM_PRO_TD) ?></label></td>
			  <td> 
			   <div class="wpmm-switch">
			      ...
			      name='wpmm_settings[general_settings][hide_arrow]' value='true' <?php echo checked($hide_arrow,'true', false ); ?>/>
			...
			<td class="wpmm_meta_table"><label for="hide_menu_onmobile"><?php _e("Hide Menu On Mobile", APMM_PRO_TD) ?></label></td>
			  ...
			  <div class="wpmm-switch">
			      ...
			      name='wpmm_settings[general_settings][hide_on_mobile]' value='true' <?php echo checked($hide_on_mobile,'true', false ); ?>/>
			...
			<td class="wpmm_meta_table"><label for="hide_menu_ondesktop"><?php _e("Hide Menu On Desktop", APMM_PRO_TD) ?></label></td>
			  ...
			  <div class="wpmm-switch">
			      ...
			      name='wpmm_settings[general_settings][hide_on_desktop]' value='true' <?php echo checked($hide_on_desktop,'true', false ); ?>/>
		  ...
		  <tr>
			<td class="wpmm_meta_table"><label for="menu_icon"><?php _e("Show Menu Icon", APMM_PRO_TD) ?></label></td>
			  ...
			  <div class="wpmm-switch">
			      ...
			      name='wpmm_settings[general_settings][menu_icon]' value='enabled' <?php echo checked($menu_icon,'enabled', 'disabled' ); ?>/>
			...
			<td class="wpmm_meta_table"><label for="active_single_menu"><?php _e("Active Single Menu", APMM_PRO_TD) ?></label></td>
			  ...
			  <div class="wpmm-switch">
			      ...
			      name='wpmm_settings[general_settings][active_single_menu]' value='enabled' <?php echo checked($active_single_menu,'enabled', 'disabled' ); ?>/>
			...
			<td>
			<?php
             $menu_align = (isset($wpmmenu_item_meta['general_settings']['menu_align']) && $wpmmenu_item_meta['general_settings']['menu_align'] != '')?esc_attr($wpmmenu_item_meta['general_settings']['menu_align']):'left';
			 ?>
			    <select name='wpmm_settings[general_settings][menu_align]' class='wpmm_menu_align'>
			        <option value='left' <?php echo selected( $menu_align, 'left', false );?>><?php _e("Left", APMM_PRO_TD); ?></option>
			        <option value='right' <?php echo selected( $menu_align, 'right', false );?>><?php _e("Right", APMM_PRO_TD); ?></option>
			    <select>
			   <br/> <br/>
			...
			<td>
			<?php
             $submenu_align = (isset($wpmmenu_item_meta['general_settings']['submenu_align']) && $wpmmenu_item_meta['general_settings']['submenu_align'] != '')?esc_attr($wpmmenu_item_meta['general_settings']['submenu_align']):'left';
			 ?>
			    <select name='wpmm_settings[general_settings][submenu_align]'>
			        <option value='left' <?php echo selected( $submenu_align, 'left', false );?>><?php _e("Left", APMM_PRO_TD); ?></option>
			        <option value='right' <?php echo selected( $submenu_align, 'right', false );?>><?php _e("Right", APMM_PRO_TD); ?></option>
			    <select>
		  ...
		  <tr>
			...
			<td class="wpmm_meta_table"><label for="activate_view_more_button"><?php _e("Activate View More Button", APMM_PRO_TD) ?></label></td>
			  <td> 
			       <div class="wpmm-switch">
			          ...
			          name='wpmm_settings[general_settings][activate_view_more_btn]' value='true' <?php echo checked($activate_view_more_btn,'true', false ); ?>/>
			...
			<tr class="hide_fortopmenu viewmoreenable_option" style="<?php if($activate_view_more_btn) echo ''; else echo 'display:none;';?>">
			<td class="wpmm_meta_table"><label><?php _e("View More Button BG Color", APMM_PRO_TD) ?></label></td>
			  <td> 
			  	  <input type='text' name='wpmm_settings[general_settings][vbtn_bgcolor]' data-alpha="true"
			       value="<?php echo (isset($wpmmenu_item_meta['general_settings']['vbtn_bgcolor']) && $wpmmenu_item_meta['general_settings']['vbtn_bgcolor'] != '')?$wpmmenu_item_meta['general_settings']['vbtn_bgcolor']:'';?>" class="apmm-color-picker"/>
			  </td>
			</tr>
			<tr class="hide_fortopmenu viewmoreenable_option" style="<?php if($activate_view_more_btn) echo ''; else echo 'display:none;';?>">
			<td class="wpmm_meta_table"><label><?php _e("View More Button BG Hover Color", APMM_PRO_TD) ?></label></td>
			  <td> 
			  	  <input type='text' name='wpmm_settings[general_settings][vbtn_bghcolor]' data-alpha="true"
			       value="<?php echo (isset($wpmmenu_item_meta['general_settings']['vbtn_bghcolor']) && $wpmmenu_item_meta['general_settings']['vbtn_bghcolor'] != '')?$wpmmenu_item_meta['general_settings']['vbtn_bghcolor']:'';?>" class="apmm-color-picker"/>
			  </td>
			</tr>
			<tr class="hide_fortopmenu viewmoreenable_option" style="<?php if($activate_view_more_btn) echo ''; else echo 'display:none;';?>">
			<td class="wpmm_meta_table"><label><?php _e("View More Button Font Color", APMM_PRO_TD) ?></label></td>
			  <td> 
			  	  <input type='text' name='wpmm_settings[general_settings][vbtn_fcolor]' 
			       value="<?php echo (isset($wpmmenu_item_meta['general_settings']['vbtn_fcolor']) && $wpmmenu_item_meta['general_settings']['vbtn_fcolor'] != '')?$wpmmenu_item_meta['general_settings']['vbtn_fcolor']:'';?>" class="apmm-color-picker"/>
			  </td>
			</tr>
			<tr class="hide_fortopmenu viewmoreenable_option" style="<?php if($activate_view_more_btn) echo ''; else echo 'display:none;';?>">
			<td class="wpmm_meta_table"><label><?php _e("View More Button Font Hover Color", APMM_PRO_TD) ?></label></td>
			  <td> 
			  	  <input type='text' name='wpmm_settings[general_settings][vbtn_fhcolor]' 
			       value="<?php echo (isset($wpmmenu_item_meta['general_settings']['vbtn_fhcolor']) && $wpmmenu_item_meta['general_settings']['vbtn_fhcolor'] != '')?$wpmmenu_item_meta['general_settings']['vbtn_fhcolor']:'';?>" class="apmm-color-picker"/>
			  </td>
			</tr>
			...
			<tr class="show_for_tabbed">
			<td class="wpmm_meta_table"><label for="tab_layouts"><?php _e("Choose Tab Layouts", APMM_PRO_TD) ?></label></td>
			  <td> 
			  <?php $tab_layouts = (isset($wpmmenu_item_meta['general_settings']['tab_layouts']) && $wpmmenu_item_meta['general_settings']['tab_layouts'] != '')?esc_attr($wpmmenu_item_meta['general_settings']['tab_layouts']):"wpmm-default-tab-design"; ?>
			        <select name="wpmm_settings[general_settings][tab_layouts]" class="wpmm-selection">
                               <option value="wpmm-default-tab-design" <?php if($tab_layouts == "wpmm-default-tab-design") echo "selected='selected'";?>><?php _e('Default Layout',APMM_PRO_TD);?></option>
                               <option value="wpmm-simple-design-layout" <?php if($tab_layouts == "wpmm-simple-design-layout") echo "selected='selected'";?>><?php _e('Simple Design Layout',APMM_PRO_TD);?></option>
                               <option value="wpmm-animated-border-design" <?php if($tab_layouts == "wpmm-animated-border-design") echo "selected='selected'";?>><?php _e('Animated Border Design',APMM_PRO_TD);?></option>
                               <option value="wpmm-creative-tab-design" <?php if($tab_layouts == "wpmm-creative-tab-design") echo "selected='selected'";?>><?php _e('Creative Tab Design',APMM_PRO_TD);?></option>
                               <option value="wpmm-modern-tab-design" <?php if($tab_layouts == "wpmm-modern-tab-design") echo "selected='selected'";?>><?php _e('Modern Tab Design',APMM_PRO_TD);?></option>
                    </select>
                      <p class="description"><?php _e("Choose tab layout design. Selected design layout will work for both horizontal and verical tab.", APMM_PRO_TD); ?></p>
			  </td>
			</tr>
