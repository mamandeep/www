/**
 * WP Mega Menu Pro - 2.0.4 version Admin JS Script
 */
...
$('#menu-to-edit li.menu-item').each(function() {
    ...
    .on('click', function(e) {
        ...
        success: function(res) {
         ...
         //var editorIdd = $('#wpmm_html_content_'+id);
                  var key = $('#wpmm_menu_'+id).find('.wpmm_key_unique').val();

                  var key1 = "wpmm_html_content";
                  var key21 = "wpmm_html_content_"+id+'_'+ key;
                      // this is need for the tabs to work
                      quicktags({id : key21}); // use wordpress settings
                      tinymce.init({
                            selector: key21,
                            selector:"#" + key21,
                            theme:"modern",
                    ...
                    var key24 = "wpmm_html_content_"+ key;
                     quicktags({id : key24});
...
var viewmorebtn_check = $('#wpmm_menu_'+id+' #activate_view_more_button');
...
/**************************************** CHECK MEGAMENU OR FLYOUT TYPE START ***********************************/
    ...
    $('.wpmm_mega_settings_multiple').hide();
}
...
menu_type.on('change', function() {
                if ( $(this).val() == 'megamenu' ) { //megamenu
                    ...
                    if(grouptype == 'single'){
                       ...
                       $('.main_widget').show();
                       $('.wpmm_mega_settings_multiple').show();
                   }
